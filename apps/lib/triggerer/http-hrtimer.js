...
const diffHrtime =  function(b/*: [number, number]*/, a/*: [number, number]*/){
  const [as, ans] = a,
        [bs, bns] = b
...
const hrToMs = (hrtime/*: [number, number]*/)/*: number*/ => hrtime[0] * 1e3 + hrtime[1] / 1e6
...
module.exports.toMsTimings = (
  ...
  refTime/*: []*/
)/*: MsTimings */ => Object.entries(obj).map(([k,v]) => {
